...
},{}],"../utils/address.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Address = exports.ADDRESS_PREFIX_REGEX = exports.ADDRESS_PREFIX_BYTE = exports.ADDRESS_PREFIX = exports.ADDRESS_SIZE = void 0;
...
var Address = {
   ...
   * @return {Boolean}
   */
  isHexAddress: function isHexAddress(address) {
   ...
   * @return {Boolean}
   */
  isChecksumHexAddress: function isChecksumHexAddress(address) {
    // Check each case
...
exports.ADDRESS_PREFIX_BYTE = ADDRESS_PREFIX_BYTE;
var ADDRESS_PREFIX_REGEX = /^(41)/;
exports.ADDRESS_PREFIX_REGEX = ADDRESS_PREFIX_REGEX;
},{}],"../TronLink.js":[function(require,module,exports) {
"use strict";
 ...
 */
var TronLink = /*#__PURE__*/function () {
  /**
   ...
   */
  function TronLink(tronWeb) {
    _classCallCheck(this, TronLink);
  ...
  _createClass(TronLink, [{
    ...
    key: "convertAddress",
    value: function convertAddress(address, fromFormat, toFormat) {
      ...
      switch (toFormat) {
        ...
        case "trx":
          switch (fromFormat) {
            case "hex":
              if (!_address.Address.isHexAddress(address)) {
...
},{"./utils/address":"../utils/address.js"}],"../utils/const.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    checkTronLink: function checkTronLink() {
      if (window && window.hasOwnProperty("tronWeb")) {
        ...
        if (!this.tronLink) {
          this.tronLink = new _TronLink.default(this.tronWeb);
        }
    ...
    notify_tron_not_install: function notify_tron_not_install() {
    ...
    notify_tron_installed: function notify_tron_installed() {
      var _this2 = this;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                window.addEventListener('message', function (_ref) {
                  ...
                  if (isTronLink) {
                    if (message.action === 'tabReply' && !_this2.tronLinkInitialData) {
                      _this2.tronLinkInitialData = message.data.data;

                      _this2.prenodenume(_this2.tronLinkInitialData.node.full_node);

                      _this2.$emit("notify_tron_initialization", _this2.tronLinkInitialData);
                    }

                    if (message.action === 'setNode') {
                      _this2.prenodenume(message.data.node.fullNode);

                      _this2.$emit("notify_tron_node_change", _this2.connectedNode);
                    }

                    if (message.action === 'setAccount') {
                      if (_this2.account_name !== message.data.name) {
                        _this2.account_name = message.data.name;
                        _this2.authorized_address = message.data.address;

                        _this2.$emit("notify_tron_account_set", _this2.account_name, _this2.authorized_address);
                      }
                    }
                ...
                _context.next = 3;
                return _this2.updateNodeVersion();

              case 3:
                // ts-ignore
                provider = _this2.tronLink.tronWeb.currentProvider();
                ...
                _this2.prenodenume(provider.fullNode.host);

                _this2.$emit("notify_tron_installed");
    ...
    updateNodeVersion: function updateNodeVersion() {
      var _this3 = this;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this3.tronWeb.getFullnodeVersion();

              case 2:
                version = _context2.sent;
                _this3.node_version = version;
    ...
    debugTronLink: function debugTronLink(bool) {
...
exports.default = _default;
},{"../TronLink":"../TronLink.js","../utils/const":"../utils/const.js"}],"../../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
...
},{}],"../components/TronAnchor.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  props: {
    network: {
      type: String,
      default: _const.FULL_NAMES.SHASTA
    },
    type: {
      type: String,
      required: true
  ...
  methods: {
    getURL: function getURL() {
      ...
      switch (this.network) {
        case _const.FULL_NAMES.MAINNET:
          baseUrl += "tronscan.org/#";
          break;

        case _const.FULL_NAMES.SHASTA:
          baseUrl += "shasta.tronscan.org/#";
          break;

        case _const.FULL_NAMES.TRONEX:
          baseUrl += "shasta.tronscan.org/#";
          break;

        case _const.FULL_NAMES.NILE:
          baseUrl += "shasta.tronscan.org/#";
          break;
      }
...
exports.default = _default;
        var $39e596 = exports.default || module.exports;
      
      if (typeof $39e596 === 'function') {
        $39e596 = $39e596.options;
      }
    
        /* template */
        Object.assign($39e596, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "a",
    _vm._b({ attrs: { href: _vm.getURL() } }, "a", _vm.$attrs, false),
    [_vm._t("default")],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$39e596', $39e596);
          } else {
            api.reload('$39e596', $39e596);
          }
        }
...
},{"../utils/const":"../utils/const.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"TronTest.vue":[function(require,module,exports) {
"use strict";
...
var _vueTronlink = _interopRequireDefault(require("../mixins/vue-tronlink"));

var _TronAnchor = _interopRequireDefault(require("../components/TronAnchor"));
...
var _default = {
  name: "Tronmasonic",
  components: {
    TronAnchor: _TronAnchor.default
  },
  comments: {},
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      _this.$on("notify_tron_node_change", function () {
...
exports.default = _default;
        var $56f2e9 = exports.default || module.exports;
      
      if (typeof $56f2e9 === 'function') {
        $56f2e9 = $56f2e9.options;
      }
    
        /* template */
        Object.assign($56f2e9, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$56f2e9', $56f2e9);
          } else {
            api.reload('$56f2e9', $56f2e9);
          }
        }
...
},{"../mixins/vue-tronlink":"../mixins/vue-tronlink.js","../components/TronAnchor":"../components/TronAnchor.vue","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";

var _vue = _interopRequireDefault(require("vue"));

var _TronTest = _interopRequireDefault(require("./TronTest"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

new _vue.default({
  render: function render(h) {
    return h(_TronTest.default);
  }
}).$mount('#app');
...
},{"vue":"../../node_modules/vue/dist/vue.runtime.esm.js","./TronTest":"TronTest.vue"}],"../../node_modules/_parcel-bundler@1.12.4@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
